...
<section className="nw-customer-section">
  <div className="nw-customer-container">
    ...
    {/* LEFT CONTENT */}
    <div className="nw-customer-left">
      ...
      <section className="nw-fit-section">
        <div className="nw-fit-container">
          ...
          <div className="nw-fit-right">
            ...
            <div className="nw-fit-card">
              <h3>Wholesale & Distribution</h3>
              <p>
                Supply of routers, switches, firewalls, access points
                and structured networking components.
              </p>
            </div>
            ...
            <div className="nw-fit-card">
              ...
              <p>
                Official partnerships with networking hardware
                manufacturers and communication technology brands.
              </p>
            </div>
            ...
            <div className="nw-fit-card">
              ...
              <p>
                Professional setup, commissioning and optimization
                of networking and communication systems.
              </p>
            </div>
            ...
            <div className="nw-fit-card">
              ...
              <p>
                Ongoing support, upgrades, warranty services
            ...
            <div className="nw-fit-card">
              ...
              <p>
                Strategic planning and architecture for scalable,
                secure and future-ready network environments.
              </p>
            </div>

            <div className="nw-fit-card">
              <h3>Refurbishment & Upgrades</h3>
              <p>
                Hardware lifecycle management, system upgrades
                and performance enhancement solutions.
              </p>
            </div>
            ...
            <div className="nw-fit-card">
              ...
              <p>
                Preventive maintenance, monitoring and priority
                service coverage for networking infrastructure.
              </p>
            </div>
